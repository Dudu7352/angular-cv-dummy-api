...
const articles = [
  ...
  },
  {
    id: 3,
    head: 'My knowledge',
    content: 'Thanks to embracing the software development as my passion, I have learnt multiple languages such as Kotlin, Java, Javascript, Typescript, Python, Rust and several libraries/frameworks, including Spring Boot, React, Actix Web and Jetpack Compose. From hackathons to internships, I always chose to face the challenges, grow and learn. As a result, my skill and deep understanding of them is much better and clearer.',
